...
const Register = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    // Accept multiple possible response shapes from API/mocks
    ...
    // fallback: errors array or message
    const errorMsg = (response && response.errors && response.errors[0]) || response.message || 'Registration failed';
    setToastType('error');
